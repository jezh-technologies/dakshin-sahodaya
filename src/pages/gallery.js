        ...
        <nav className="navbar navbar-expand-lg bg-white px-lg-5 px-0 pt-0">
          ...
          <img src="/images/dakshilogo.jpg" className="img-fluid rounded-1" width="80" height="60" alt=""/>
            ...
            <div className="collapse text-center navbar-collapse" id="navbarSupportedContent">
              <ul className="navbar-nav ms-auto mb-2 mb-lg-0 fw-bold fs-5 bg-light rounded-5 px-2 py-1 align-middle">
                <li className="nav-item px-lg-2">
                <Link href='/' ><a className="nav-link bg-lg-none rounded-3 px-" href="#">Home</a></Link>
                </li>
                <li className="nav-item px-lg-2">
                  <a className="nav-link bg-lg-none rounded-3 px-" href="#">About Us</a>
                </li>
                <li className="nav-item px-lg-2">
                <Link href='/gallery' ><a className='nav-link bg-lg-none rounded-3 px- active' style={{color:"#FF512F"}} aria-current="page">Gallery</a></Link>
                </li>
                <li className="nav-item px-lg-2">
                <Link href='/board-members' ><a className="nav-link bg-lg-none rounded-3 px-">Board Members</a></Link>
                </li>
              </ul>
